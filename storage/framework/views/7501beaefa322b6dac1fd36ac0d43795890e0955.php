            ...
            <div class="input-group input-group-sm" style="width: 150px;">
                ...
                <select name="connection" id="connections" class="form-control pull-right" style="margin-right: 10px;">
                    ...
                    <?php if(!empty($connections['dbs'])): ?>
                        <optgroup label="dbs">
                        <?php foreach($connections['dbs'] as $db): ?>
                            <option value="<?php echo e($db['value']); ?>" <?php echo e($db['selected'] ? 'selected':''); ?>><?php echo e($db['option']); ?></option>
                        <?php endforeach; ?>
                        </optgroup>
                    <?php endif; ?>
                    ...
                    <?php if(!empty($connections['redis'])): ?>
                        <optgroup label="redis">
                            <?php foreach($connections['redis'] as $redis): ?>
                                <option value="<?php echo e($redis['value']); ?>"><?php echo e($redis['option']); ?></option>
                            <?php endforeach; ?>
                        </optgroup>
                    <?php endif; ?>
